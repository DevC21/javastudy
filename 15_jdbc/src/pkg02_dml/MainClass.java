...
public class MainClass {
	...
	public static void method1() {
		...
		try {
			...
			// 쿼리문
			String sql = "INSERT INTO SAMPLE_T(SAMPLE_NO, SAMPLE_CONTENT, SAMPLE_EDITOR, SAMPLE_DT) "
					+ "VALUES(SAMPLE_SEQ.NEXTVAL, '콘텐츠', '에디터', CURRENT_DATE)";
	...
	public static void method2() {
		...
		try {
			...
			String sql = "INSERT INTO SAMPLE_T(SAMPLE_NO, SAMPLE_CONTENT, SAMPLE_EDITOR, SAMPLE_DT) "
					+ "VALUES(SAMPLE_SEQ.NEXTVAL, ?, ?, CURRENT_DATE)";
	...
	public static void method3() {
		...
		try {
			...
			String sql = "UPDATE SAMPLE_T "
					+ "SET SAMPLE_EDITOR = SAMPLE_EDITOR || 2"
					+ ", SAMPLE_DT = CURRENT_DATE "
					+ "WHERE SAMPLE_NO = ?";
			...
			System.out.println("SAMPLE_NO 입력하세요 >>> ");
			int sample_no = sc.nextInt();
		
			sc.close();
			
			ps.setInt(1, sample_no); // 쿼리문의 1번째 물음표에 int sample_no 전달하기
	...
	public static void method4() {
		...
		try {
			...
			System.out.println("지울 SAMPLE_NO 입력하세요 >>> ");
			int sample_no = sc.nextInt();
			...
			System.out.println(result + " 행 이(가) 지워졌습니다.");
